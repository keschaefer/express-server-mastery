...
app.get('/', (req, res) => res.json({
  ...
  "usage": 'GET routes: Use the "cakes" or "students" endpoints to get cakes or students. Use "cakes/[number]" to get a specific cake, or the same with students POST routes: Use "/cakes" or "/students" endpoints to post. PUT/DELETE routes: Use "/cakes/[id number]" or "/students/[id number] to put or delete."'
}))
